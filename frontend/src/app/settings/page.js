...
const ACTIONS = [
  ...
  { id: 'generate_report', label: 'Generate Daily Report', desc: 'Generate AI-powered daily portfolio report', icon: FileText, endpoint: '/ai/report', method: 'POST' },
  ...
  { id: 'run_stress_test', label: 'Run Stress Test', desc: 'Run 5 predefined stress scenarios', icon: AlertTriangle, endpoint: '/risk/stress-test', method: 'POST', body: { positions: [], scenarios: [] } },
];
